...
# MongoDB Connection
Hari = pg.MongoClient("mongodb+srv://hariprakashpm:Kavyalaya@cluster0.rcugtle.mongodb.net/?retryWrites=true&w=majority")

#Creating database
db  = Hari["Youtube_Database"]
...
if submit1:
    ...
    #MySQL Database Connection:
        ...
        engine = create_engine('mysql+mysqlconnector://root:@localhost/youtube_data_warehousing')
